export const querySelectors = {
    ...
    banner: ['div[role=alert]', 'div:has(>table[role=presentation])', 
        '.oj-sp-banner-container.oj-sp-banner-layout.oj-private-scale-lg.oj-sp-common-banner-content-layout'],
