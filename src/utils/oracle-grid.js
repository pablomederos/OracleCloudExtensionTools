...
export function findFirstEmptyCellByDate(isoDateString) {
...
export function processTaskInsertion(task) {
...
async function handleCellActivation(emptyCell, value, taskId, taskTitle, taskDate) {
...
export function startCompletionCheck() {
